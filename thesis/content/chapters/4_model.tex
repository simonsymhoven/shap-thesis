...
\lstinputlisting[language=Python,label=code:model-train, firstline=236, lastline=242, 
...
\lstinputlisting[language=Python,label=code:shap, firstline=248, lastline=249, 
