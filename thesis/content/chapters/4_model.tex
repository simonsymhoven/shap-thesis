...
\lstinputlisting[language=Python,label=code:model-train, firstline=222, lastline=228, 
...
\lstinputlisting[language=Python,label=code:shap, firstline=234, lastline=235, 
