...
außerhalb der Koalition $\mathcal{S}$ repräsentiert. Die Integrale repräsentieren den erwarteten 
Output des Modells über die Verteilung der nicht in der Koalition enthaltenen Merkmale.
...
über die Verteilungen aller Merkmale, kann der Fokus auf die Unterschiede in den Modelloutputs gelegt werden, 
...
auf den Output des Modells additiv und unabhängig sind. Bei komplexeren, 
